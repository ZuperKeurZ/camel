...
public class RabbitMQComponent extends DefaultComponent {
    ...
    protected RabbitMQEndpoint createEndpoint(String uri, String remaining, Map<String, Object> params) throws Exception {
        ...
        Map<String, Object> additionalHeaders = resolveAndRemoveReferenceParameter(params, "additionalHeaders", SimpleDataHolderBean.class, null).getMapData();
        Map<String, Object> additionalProperties = resolveAndRemoveReferenceParameter(params, "additionalProperties", SimpleDataHolderBean.class, null).getMapData();
     ...
     * {@link com.rabbitmq.client.AMQP.BasicProperties}
     * The map keys should be from {@link org.apache.camel.component.rabbitmq.RabbitMQConstants}.
     * Any other keys will be ignored. When the message already contains these headers they will
     * be given precedence over these properties.
     */
